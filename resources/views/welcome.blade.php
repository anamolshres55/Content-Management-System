...
<!-- Header -->
<header class="header text-center text-white" style="background-image: linear-gradient(-225deg, #0f0c29 0%, #302b63 48%, #24243e 100%);">
  <div class="container">

    <div class="row">
      <div class="col-md-8 mx-auto">

        <h1> Random Writings</h1>
        <!-- <p class="lead-2 opacity-90 mt-6">Read and get latest news about gadgets</p> -->
